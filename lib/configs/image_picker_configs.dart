...
class ImagePickerConfigs {
  ...
  ///
  /// Defaults to "Camera".
  String get textCameraTitle => getTranslatedString("image_picker_camera_title", "Scan");
  ...
  String get textRequestPermission => getTranslatedString("image_picker_request_permission", "Request Permission");
  ...
  String get textRequestCameraPermission =>
      getTranslatedString("image_picker_request_camera_permission", "You need allow camera permission.");
  ...
  String get textRequestGalleryPermission =>
      getTranslatedString("image_picker_request_gallery_permission", "You need allow photo gallery permission.");
